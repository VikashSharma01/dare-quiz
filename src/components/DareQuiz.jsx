        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              Number: 3,
              option: 'Parrot',
              url: 'https://cdn.cdnparenting.com/articles/2019/06/01154838/Parrot-Facts-for-Kids-1115777186.jpg',
            },
            {
              Number: 4,
              option: 'Rabbit',
              url: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/rabbit-breeds-american-white-1553635287.jpg?crop=0.976xw:0.651xh;0.0242xw,0.291xh&resize=480:*',
            },
          ],
        },
      ],
    ...
    return (
      <Container>
        <Row>
          ...
          <Col xs={12} className="text-center pt-3">
            <Button variant="danger px-3">Skip This Question</Button>
          </Col>
        </Row>
        <Row>
